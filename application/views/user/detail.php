  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url()."index.php/ApiSrtMsk/webGetAllSrt"; ?>">Surat Masuk</a></li>
        <li><a href="#">Detail Surat</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-success">
            ...
            <!-- /.box-header -->
            <!-- form start -->
                <form class="form-horizontal" action="<?php echo base_url().'index.php/web/User/ubah/'; ?>" method="post" name="myForm">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="text" name="nama" class="form-control" id="inputEmail3" value="<?php echo $data['nama'] ?>" required>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="text" name="nama_panggilan" class="form-control" id="inputPassword3" value="<?php echo $data['nama_panggilan'] ?>" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="text" name="username" class="form-control" id="inputPassword3" value="<?php echo $data['username'] ?>" required>
                      </div>
                    </div>
